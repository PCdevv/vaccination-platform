...
const Dashboard = () => {
    ...
    return (
        <div className="flex flex-col h-screen">
                    ...
                    <table className="border-collapse table-auto bg-slate-300 ml-10 mt-4 p-2 w-96 rounded-md items-start">
                        ...
                        <tbody>
                            ...
                            <tr className="bg-slate-100">
                                ...
                                <td className="py-2 pr-4">
                                    {consuls && consuls[0].disease_history}
                                </td>
                            </tr>
                            <tr className="bg-slate-200">
                                <td className="py-2 pl-4">Current Symptoms</td>
                                <td className="py-2 pr-4">
                                    {consuls && consuls[0].current_symptoms}
                                </td>
                            </tr>
                            <tr className="bg-slate-100">
                                <td className="py-2 pl-4">Doctor Name</td>
                                <td className="py-2 pr-4">
                                    {consuls && consuls[0].doctor_id}
                                </td>
                            </tr>
                            <tr className="bg-slate-200">
                                <td className="py-2 pl-4">Doctor Notes</td>
                                <td className="py-2 pr-4">
                                    {consuls && consuls[0].doctor_notes}
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            {consuls.length == 0 || consuls[0].status != "accepted" ? (
                // <div className="">
                // {consuls[0].status != "accepted" ||
                // (!consuls.length && (
